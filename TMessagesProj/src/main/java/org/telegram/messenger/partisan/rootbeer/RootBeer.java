 ...
 * Only the package and the native-library wiring differ from upstream: the
 * native root check lives in the main tmessages library instead of a separate
 * libtoolChecker.so (see jni/partisan/rootbeer/toolChecker.cpp), so nothing in
 * the APK reveals the app.
 */
...
import static org.telegram.messenger.partisan.rootbeer.Const.BINARY_BUSYBOX;
import static org.telegram.messenger.partisan.rootbeer.Const.BINARY_SU;
