        ...
        if (chat != null) {
            if (chat.monoforum) {
                ...
                if (mfChat != null) {
                    ...
                    nameString = AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(UserConfig.getChatTitleOverride(currentAccount, chat)));
                }
            } else if (nameString == null) {
                nameString = AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(UserConfig.getChatTitleOverride(currentAccount, chat)));
            }
        } else if (nameString == null && user != null) {
            nameString = AndroidUtilities.removeRTL(AndroidUtilities.removeDiacritics(UserObject.getUserName(user, currentAccount)));
        }
    ...
    public void update(int mask) {
        ...
        if (user != null) {
            ...
            if (UserObject.isReplyUser(user)) {
                ...
                avatarImage.setImage(ImageLocation.getForUserOrChat(currentAccount, user, ImageLocation.TYPE_SMALL), "50_50", ImageLocation.getForUserOrChat(currentAccount, user, ImageLocation.TYPE_STRIPPED), "50_50", thumb, user, 0);
            }
        } else if (chat != null) {
            Drawable thumb = avatarDrawable;
            ...
            if (chat.monoforum) {
                ...
                avatarImage.setImage(ImageLocation.getForUserOrChat(currentAccount, chat, ImageLocation.TYPE_SMALL), "50_50", ImageLocation.getForUserOrChat(currentAccount, chat, ImageLocation.TYPE_STRIPPED), "50_50", thumb, chat, 0);
            }
        } else if (contact != null) {
        ...
        if (user != null) {
            ...
            lastName = chat.monoforum ?
                ...
                UserConfig.getChatTitleOverride(currentAccount, chat);
        }
