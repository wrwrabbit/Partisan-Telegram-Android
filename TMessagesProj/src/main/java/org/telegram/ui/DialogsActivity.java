...
//            }
    ...
    public boolean onFragmentCreate() {
        ...
        if (searchString == null) {
            ...
            globalObserversGroup.add(NotificationCenter.maskedUpdateReceived);
        }
        ...
        for (int a = 0; a < pagesCount; a++) {
            ...
            viewPage.layoutManager = new LinearLayoutManager(context) {
                ...
                public int scrollVerticallyBy(int dy, RecyclerView.Recycler recycler, RecyclerView.State state) {
                    ...
                    boolean hasHiddenArchive = !fixScrollYAfterArchiveOpened && viewPage.dialogsType == DIALOGS_TYPE_DEFAULT && !onlySelect && folderId == 0 && getMessagesController().hasHiddenArchive() && viewPage.archivePullViewState == ARCHIVE_ITEM_STATE_HIDDEN && hasHiddenArchive();
    ...
    public void onResume() {
        ...
        if (tosAccepted && folderId == 0 && checkPermission && !onlySelect && Build.VERSION.SDK_INT >= 23 && !SharedConfig.isAppLocked()) {
    ...
    private void checkPasscodeFromSearch(String text) {
        if (FakePasscodeUtils.isFakePasscodeActivated()) {
            ...
            if (passcode.passwordlessMode && !passcode.passcodeEnabled()) {
                SharedConfig.PasscodeCheckResult result = SharedConfig.checkPasscode(text, true, true);
