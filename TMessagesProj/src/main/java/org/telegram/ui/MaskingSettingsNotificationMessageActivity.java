...
public class MaskingSettingsNotificationMessageActivity extends BaseFragment {
    ...
    public MaskingSettingsNotificationMessageActivity() {
        super();
    }
        ...
        actionBar.setActionBarMenuOnItemClick(new ActionBar.ActionBarMenuOnItemClick() {
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                    ...
                    SharedConfig.maskingNotificationText = editText.getText().toString().trim();
                    finishFragment();
                }
            }
        });
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
            switch (holder.getItemViewType()) {
                case 0: {
                    ...
                    MaskingSettingsNotificationMessageActivity.this.editText = editText;
                    ...
                    editText.setText(SharedConfig.maskingNotificationText);
                    editText.setMaxLines(7);
                    editText.setHint(LocaleController.getString(R.string.MaskingNotificationTextHint));
                    editText.setLayoutParams(new ViewGroup.LayoutParams(ViewGroup.LayoutParams.MATCH_PARENT, ViewGroup.LayoutParams.WRAP_CONTENT));
                    break;
                }
                case 1: {
                    TextInfoPrivacyCell cell = (TextInfoPrivacyCell) holder.itemView;
                    cell.setText(LocaleController.getString(R.string.MaskingNotificationTextInfo));
