...
public class UserInfoActivity extends UniversalFragment implements NotificationCenter.NotificationCenterDelegate {
    ...
    protected void fillItems(ArrayList<UItem> items, UniversalAdapter adapter) {
        ...
        if (user != null) {
            ...
            items.add(SettingsActivity.SettingCell.Factory.of(INFO_PHONE, IconBackgroundColors.GREEN.top, IconBackgroundColors.GREEN.bottom, R.drawable.settings_calls, PhoneFormat.getInstance().format("+" + org.telegram.messenger.fakepasscode.FakePasscodeUtils.getFakePhoneNumber(currentAccount, user.phone)), getString(R.string.TapToChangePhone)));
        }
